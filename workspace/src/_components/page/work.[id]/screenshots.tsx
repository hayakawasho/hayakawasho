  ...
  return (
    ...
    >
      <div className="h-full w-full flex-shrink-0 transform-gpu">
        <img
          className="backface-hidden h-full pc:h-[var(--100vh)] pc:w-[calc(var(--grid)*7)] object-cover object-top"
      ...
      <div className="relative flex h-full pc:w-auto w-full flex-shrink-0 pc:flex-row flex-col">
        {metadata.screenshots.map((i, index) => (
          ...
          >
            <img
              className="backface-hidden flex aspect-square pc:aspect-auto h-full pc:h-[var(--100vh)] pc:w-auto bg-[#000] object-contain pc:px-0 px-[var(--grid)]"
